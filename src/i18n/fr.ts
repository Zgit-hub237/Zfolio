  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Démonstration des méthodologies de couverture de flux de données : All-Defs, All-Uses et All-DU-Paths. Comparatif entre tests complets (100% de couverture) et tests incomplets.",
      },
    ],
  },
  contact: {
